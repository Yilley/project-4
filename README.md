[![Yilley](https://circleci.com/gh/Yilley/project-4.svg?style=svg)](https://circleci.com/gh/Yilley/project-4)
...
-   Define a `dockerpath` which is `<docker_hub_username>/<project_name>` e.g: `yilley/udacity-p4`
...
-   Add a status badge using this template: `[![<github_username>](https://circleci.com/gh/<github_username>/<repository>.svg?style=svg)](https://circleci.com/gh/<github_username>/<repository>)` replace `<github_username>` and `<repository>` with your data. e.g: `[![Yilley](https://circleci.com/gh/Yilley/project-4.svg?style=svg)](https://circleci.com/gh/Yilley/project-4)` and paste on top of your readme file.
